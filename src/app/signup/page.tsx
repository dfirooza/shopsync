      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded border border-border-light shadow-sf-lg p-8">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-sf-gray-1 mb-1">Create Account</h1>
            <p className="text-sm text-sf-gray-3">Join ShopSync to discover local businesses</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-sf-gray-3 mt-1.5 ml-1">Must be at least 6 characters</p>
            </div>
            ...
            {message && (
              <div className="p-3 bg-sf-success-light border border-sf-success rounded flex items-start gap-2">
                <svg className="w-4 h-4 text-sf-success flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <p className="text-sf-success text-sm font-medium">{message}</p>
              </div>
            )}
          ...
          <div className="mt-5 text-center">
            <p className="text-sm text-sf-gray-3">
              ...
              <Link href="/login" className="font-semibold text-sf-blue-primary hover:text-sf-blue-dark transition-colors">
                Sign in
              </Link>
            </p>
          </div>
